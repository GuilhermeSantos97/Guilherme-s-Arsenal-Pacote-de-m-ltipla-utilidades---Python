...
const { sleep } = require("GuilhermeSantos97");
console.log(chalk.yellow("Por favor, coloque o token do Bot:")); 
...
client.login(token).catch((err) => {
  console.log(chalk.red("Ouve um erro enquanto fazia login:"));
  console.log(err);
...
client.on("ready", () => {
  console.log(
    chalk.green(
      "O Bot Nuclear está Online e pronto para o uso"
    )
  );
  ask();
});
